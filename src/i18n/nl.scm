(define-module (byggsteg-i18n-nl)
  #:use-module (ice-9 format)
  )

(define-public dict-nl
  `(
    (run-job-title . "job draaien")
    (add-profile-title . "profiel toevoegen")
    (byggsteg-word-meaning . "byggsteg betekent “bouwstap” in het Noors.")

(define-module (byggsteg-i18n-en)
  #:use-module (ice-9 format)
  )

(define-public dict-en
  `(
    (run-job-title . "run a job")
    (add-profile-title . "add a profile")
    (byggsteg-word-meaning . "byggsteg means “build step” in Norwegian.")
